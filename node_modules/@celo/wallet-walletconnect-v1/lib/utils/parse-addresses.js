...
function parseShortNameAddress(addressLike) {
    ...
    if (!celo || !address || invalidChain(celo) || !(0, address_1.isValidAddress)(address)) {
...
function parseCaip50Address(addressLike) {
    ...
    if (!chain || !address || !(0, address_1.isValidAddress)(address) || invalidChain(chain)) {
...
function parseCaip10Address(addressLike) {
    ...
    if (!address || !chain || !(0, address_1.isValidAddress)(address) || invalidChain(chain)) {
